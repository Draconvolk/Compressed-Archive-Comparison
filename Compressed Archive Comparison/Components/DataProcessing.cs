...
{
    public class DataProcessing(IExceptionList exceptionList, ICompressionFactory compressionFactory)
    {
        private readonly string DP = "DataProcessing";

        /// <summary>
        /// Valid File Extensions for Output File to be written to
        /// </summary>
        public readonly List<string> ValidFileExtensions = [".log", ".txt"];
        public readonly string DefaultSeparator = Environment.NewLine;
        public readonly string fileSeparator = "|";
        ...
        /// <returns></returns>
        public IInfo GetAsInfo(string jsonData)
        {
        ...
        /// <returns></returns>
        public IEnumerable<string> GetCompressedFileContent(string filePath)
        {
        ...
        /// <returns></returns>
        public IEnumerable<string> GetCompressedFileList(IInfo info)
        {
        ...
        /// <returns></returns>
        public IEnumerable<string> GetCompressedOfType(IInfo info, string type)
        {
            var files = new List<string>();
            try
            {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        public IEnumerable<string> GetDirectoryFileList(IInfo info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        public async Task<string> GetExclusionFileText(IInfo info)
        {
            try
            {
        ...
        /// <returns></returns>		
        public IEnumerable<string> GetMissingSourceFiles(IEnumerable<string> sourceList, IEnumerable<string> destinationList)
        {
        ...
        /// <param name="destinationList"></param>
        /// <returns></returns>
        public async Task<IEnumerable<string>> DetermineMissingFiles(string file, IEnumerable<string> destinationList)
        {
            try
            {
        ...
        /// <returns></returns>
        public IEnumerable<string> OnlyFiles(IEnumerable<string> compressedFileContent)
        {
        ...
        /// <returns></returns>
        public async Task<IEnumerable<string>> FilterDestination(IEnumerable<string> destinationList, string targetFolder)
        {
        ...
        /// <returns></returns>
        public IEnumerable<string> FilterMissingFiles(IEnumerable<string> targetDestList, IEnumerable<string> justCompressedFiles)
        {
        ...
        /// <returns></returns>
        public IEnumerable<string> AddPathToValue(IEnumerable<string> list, string addPath, string separator)
        {
            try
            {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        public bool IsValidInfo(IInfo info)
            => !(info == null
        ...
        /// <param name="separator"></param>
        /// <returns></returns>
        public IEnumerable<string> ParseExclusionFileText(string exclusionText, string separator)
        {
        ...
        /// <returns></returns>
        public async Task<string> ReadPathInfo(string jsonPath)
        {
        ...
        /// <param name="filePath"></param>
        /// <returns></returns>
        public async Task<string> ReadFileData(string filePath)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="asyncList"></param>
        /// <param name="filePath"></param>
        /// <returns></returns>
        public async Task<bool> WriteToFile(IEnumerable<string> asyncList, string filePath)
        {
